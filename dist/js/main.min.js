...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_meta_width_function_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/meta-width-function.js */ \"./src/js/modules/meta-width-function.js\");\n/* harmony import */ var _modules_animate_scroll_call_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/animate-scroll-call.js */ \"./src/js/modules/animate-scroll-call.js\");\n/* harmony import */ var _modules_pagination_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/pagination.js */ \"./src/js/modules/pagination.js\");\n/* harmony import */ var _modules_menu_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/menu.js */ \"./src/js/modules/menu.js\");\n/* harmony import */ var _modules_show_menu_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/show-menu.js */ \"./src/js/modules/show-menu.js\");\n/* harmony import */ var _modules_mobile_menu_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/mobile-menu.js */ \"./src/js/modules/mobile-menu.js\");\n/* harmony import */ var _modules_height_max_height_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/height-max-height.js */ \"./src/js/modules/height-max-height.js\");\n/* harmony import */ var _modules_anchor_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/anchor.js */ \"./src/js/modules/anchor.js\");\n/* harmony import */ var _modules_js_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/js.js */ \"./src/js/modules/js.js\");\n/* harmony import */ var _modules_accessability_mob_menu_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/accessability-mob-menu.js */ \"./src/js/modules/accessability-mob-menu.js\");\n\n// import \"./modules/animate-scroll.js\";\n// import \"./modules/animate-scroll-down.js\";\n\n\n\n\n// import \"./modules/multi-level-push-menu.js\";\n\n// import \"./modules/height-vh-root.js\";\n// import \"./modules/counter-textarea.js\";\n// import './modules/scroll-class.js'\n\n// import './modules/multi-level-push-menu-direction.js'\n\n\n\n\n//# sourceURL=webpack://ulf/./src/js/main.js?");

/***/ }),

/***/ "./src/js/modules/accessability-mob-menu.js":
/*!**************************************************!*\
  !*** ./src/js/modules/accessability-mob-menu.js ***!
  \**************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\");\n\n\n//? height = max height\n// Оголошення функції setEqualHeight\nfunction setEqualHeight(columns) {\n\tvar tallestcolumn = 0;\n\tcolumns.each(function () {\n\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(this).css('height', 'auto'); // Спочатку встановлюємо автоматичну висоту\n\t\tvar currentHeight = jquery__WEBPACK_IMPORTED_MODULE_0__(this).height();\n\t\tif (currentHeight > tallestcolumn) {\n\t\t\ttallestcolumn = currentHeight;\n\t\t}\n\t});\n\tcolumns.height(tallestcolumn);\n}\n\nwindow.addEventListener('resize', (e) => {\n\tcardResize();\n});\n\nwindow.addEventListener('load', function () {\n\tsetTimeout(() => {\n\t\tcardResize();\n\t}, 500);\n}, false);\n\nfunction cardResize() {\n\n}\n\njquery__WEBPACK_IMPORTED_MODULE_0__(document).ready(function () {\n\t// setEqualHeight($(\".popup-apply-car .car-calc .summary-item--label\"));\n});\n\n//# sourceURL=webpack://ulf/./src/js/modules/height-max-height.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\");\n/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lodash */ \"./node_modules/lodash/lodash.js\");\n\n\n\nlet lastScrollTop = 0;\nlet headerTopHeight = 0;\nlet headerMainHeight = 0;\nlet mainThreshold = 0;\n\nfunction updateThresholds() {\n\theaderTopHeight = jquery__WEBPACK_IMPORTED_MODULE_0__(\".header-top\").outerHeight() || 0;\n\theaderMainHeight = jquery__WEBPACK_IMPORTED_MODULE_0__(\".header-main\").outerHeight() || 0;\n\tmainThreshold = headerTopHeight + headerMainHeight;\n\n\tif (jquery__WEBPACK_IMPORTED_MODULE_0__(window).width() >= 1024) {\n\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\"main\").css(\"margin-top\", mainThreshold + \"px\");\n\t} else {\n\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\"main\").css(\"margin-top\", \"\");\n\t}\n\n\tupdateHeroHeight();\n}\n\nfunction updateHeroHeight() {\n\tif (jquery__WEBPACK_IMPORTED_MODULE_0__(\".section-hero.vh-max\").length) {\n\t\tif (jquery__WEBPACK_IMPORTED_MODULE_0__(window).width() >= 1024) {\n\t\t\tlet headerTotalHeight = jquery__WEBPACK_IMPORTED_MODULE_0__(\".header-top\").outerHeight() + jquery__WEBPACK_IMPORTED_MODULE_0__(\".header-main\").outerHeight();\n\t\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\".section-hero.vh-max\").css(\"height\", `calc(100vh - ${headerTotalHeight}px)`);\n\t\t} else {\n\t\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\".section-hero.vh-max\").css(\"height\", \"\");\n\t\t}\n\t}\n}\n\njquery__WEBPACK_IMPORTED_MODULE_0__(document).ready(function () {\n\tupdateThresholds();\n\n\tjquery__WEBPACK_IMPORTED_MODULE_0__(window).on(\"resize\", updateThresholds);\n\n\tjquery__WEBPACK_IMPORTED_MODULE_0__(window).on(\n\t\t\"scroll\",\n\t\t(0,lodash__WEBPACK_IMPORTED_MODULE_1__.throttle)(function () {\n\t\t\tlet st = jquery__WEBPACK_IMPORTED_MODULE_0__(this).scrollTop();\n\n\t\t\tif (jquery__WEBPACK_IMPORTED_MODULE_0__(window).width() >= 1024) {\n\t\t\t\tif (st > lastScrollTop) {\n\t\t\t\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\".header-top\").removeClass(\"header--show\").addClass(\"header--hide\");\n\t\t\t\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\".header-main\").removeClass(\"header--show\").addClass(\"header--hide\");\n\t\t\t\t\t// <- margin-top видалено\n\t\t\t\t} else {\n\t\t\t\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\".header-top\").removeClass(\"header--hide\").addClass(\"header--show\");\n\t\t\t\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\".header-main\").removeClass(\"header--hide\").addClass(\"header--show\");\n\t\t\t\t\t// <- margin-top видалено\n\t\t\t\t}\n\n\t\t\t\tif (st > headerTopHeight) {\n\t\t\t\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\".header-top\").css(\"top\", `-${headerTopHeight}px`);\n\t\t\t\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\".header-main\").css(\"top\", \"0\");\n\t\t\t\t}\n\n\t\t\t\tif (st <= headerTopHeight || st < lastScrollTop) {\n\t\t\t\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\".header-top\").css(\"top\", \"0\");\n\t\t\t\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\".header-main\").css(\"top\", `${headerTopHeight}px`);\n\t\t\t\t}\n\t\t\t} else {\n\t\t\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\".header-top, .header-main\").css(\"top\", \"\");\n\t\t\t}\n\n\t\t\tlastScrollTop = st;\n\t\t\tupdateHeroHeight();\n\t\t}, 100)\n\t);\n});\n\n\n//# sourceURL=webpack://ulf/./src/js/modules/menu.js?");

/***/ }),

/***/ "./src/js/modules/meta-width-function.js":
/*!***********************************************!*\
  !*** ./src/js/modules/meta-width-function.js ***!
  \***********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\");\n\n\n// Функція для плавної прокрутки до елемента\nfunction scrollToElement(element) {\n\tif (jquery__WEBPACK_IMPORTED_MODULE_0__(element).length > 0) {\n\t\tvar headerHeight = jquery__WEBPACK_IMPORTED_MODULE_0__('header').outerHeight();\n\t\tvar targetScroll = jquery__WEBPACK_IMPORTED_MODULE_0__(element).offset().top - headerHeight - 20;\n\t\tjquery__WEBPACK_IMPORTED_MODULE_0__('html, body').animate({ scrollTop: targetScroll }, 'slow');\n\t}\n}\n\n//? pagination\nfunction getPageList(totalPages, page, maxLength) {\n\tif (maxLength < 5) throw \"maxLength must be at least 5\";\n\n\tfunction range(start, end) {\n\t\treturn Array.from(Array(end - start + 1), (_, i) => i + start);\n\t}\n\n\tvar sideWidth = maxLength < 9 ? 1 : 2;\n\tvar leftWidth = (maxLength - sideWidth * 2 - 3) >> 1;\n\tvar rightWidth = (maxLength - sideWidth * 2 - 2) >> 1;\n\tif (totalPages <= maxLength) {\n\t\t// no breaks in list\n\t\treturn range(1, totalPages);\n\t}\n\tif (page <= maxLength - sideWidth - 1 - rightWidth) {\n\t\t// no break on left of page\n\t\treturn range(1, maxLength - sideWidth - 1)\n\t\t\t.concat([0])\n\t\t\t.concat(range(totalPages - sideWidth + 1, totalPages));\n\t}\n\tif (page >= totalPages - sideWidth - 1 - rightWidth) {\n\t\t// no break on right of page\n\t\treturn range(1, sideWidth)\n\t\t\t.concat([0])\n\t\t\t.concat(\n\t\t\t\trange(totalPages - sideWidth - 1 - rightWidth - leftWidth, totalPages)\n\t\t\t);\n\t}\n\t// Breaks on both sides\n\treturn range(1, sideWidth)\n\t\t.concat([0])\n\t\t.concat(range(page - leftWidth, page + rightWidth))\n\t\t.concat([0])\n\t\t.concat(range(totalPages - sideWidth + 1, totalPages));\n}\n\n//? pagination our-fleet\njquery__WEBPACK_IMPORTED_MODULE_0__(function () {\n\tvar targetElement = \".our-fleet\";\n\tvar numberOfItems = jquery__WEBPACK_IMPORTED_MODULE_0__(\".our-fleet .content-item\").length;\n\t// var limitPerPage = 12;\n\tvar w = screen.width;\n\tif (w < 576) {\n\t\tvar limitPerPage = 9;\n\t} else if (w < 1024) {\n\t\tvar limitPerPage = 6;\n\t} else if (w < 1200) {\n\t\tvar limitPerPage = 8;\n\t} else {\n\t\tvar limitPerPage = 9;\n\t}\n\tvar totalPages = Math.ceil(numberOfItems / limitPerPage);\n\tvar paginationSize;\n\n\tif (w < 768) {\n\t\tpaginationSize = 5;\n\t} else {\n\t\tpaginationSize = 7;\n\t}\n\tvar currentPage;\n\n\tfunction showPage(whichPage) {\n\t\tif (whichPage < 1 || whichPage > totalPages) return false;\n\t\tcurrentPage = whichPage;\n\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(targetElement + \" .content-item\").hide().slice((currentPage - 1) * limitPerPage, currentPage * limitPerPage).show();\n\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(targetElement + \" .pagination li\").slice(1, -1).remove();\n\t\tgetPageList(totalPages, currentPage, paginationSize).forEach(item => {\n\t\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\"<li>\").addClass(\"page-item \" + (item ? \"current-page \" : \"\") + (item === currentPage ? \"active \" : \"\"))\n\t\t\t\t.append(jquery__WEBPACK_IMPORTED_MODULE_0__(\"<a>\").addClass(\"page-link\").attr({ href: \"javascript:void(0)\" }).text(item || \"...\"))\n\t\t\t\t.insertBefore(targetElement + \" #next-page\");\n\t\t});\n\n\t\t// Add or remove active class from previous and next buttons\n\t\tif (currentPage === 1) {\n\t\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\"#previous-page\").addClass(\"active\");\n\t\t} else {\n\t\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\"#previous-page\").removeClass(\"active\");\n\t\t}\n\n\t\tif (currentPage === totalPages) {\n\t\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\"#next-page\").addClass(\"active\");\n\t\t} else {\n\t\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\"#next-page\").removeClass(\"active\");\n\t\t}\n\n\t\treturn true;\n\t}\n\n\t// Include the prev/next buttons:\n\tjquery__WEBPACK_IMPORTED_MODULE_0__(\".our-fleet .pagination\").append(\n\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\"<li>\").addClass(\"page-item button-slider-prev\").attr({ id: \"previous-page\" }).append(\n\t\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(`<a><svg class=\"icon i-arrow-left\"><use xlink:href=\"img/icons/icons.svg#i-arrow-down\"><span class=\"d-none d-md-block\">Попередня</span>`)\n\t\t\t\t.addClass(\"page-link\")\n\t\t\t\t.attr({\n\t\t\t\t\thref: \"javascript:void(0)\"\n\t\t\t\t})\n\t\t\t// .text(\"Prev\")\n\t\t),\n\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\"<li>\").addClass(\"page-item button-slider-next\").attr({ id: \"next-page\" }).append(\n\t\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(`<a><span class=\"d-none d-md-block\">Наступна</span><svg class=\"icon i-arrow-right\"><use xlink:href=\"img/icons/icons.svg#i-arrow-down\">`)\n\t\t\t\t.addClass(\"page-link\")\n\t\t\t\t.attr({\n\t\t\t\t\thref: \"javascript:void(0)\"\n\t\t\t\t})\n\t\t\t// .text(\"Next\")\n\t\t)\n\t);\n\t// Show the page links\n\tif (totalPages > 1) {\n\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\".our-fleet\").show();\n\t\tshowPage(1);\n\t} else {\n\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\".our-fleet .pagination\").hide();\n\t}\n\n\tjquery__WEBPACK_IMPORTED_MODULE_0__(document).on(\"click\", targetElement + \" .pagination li.current-page:not(.active)\", function () {\n\t\tvar targetPage = +jquery__WEBPACK_IMPORTED_MODULE_0__(this).text();\n\t\tshowPage(targetPage);\n\t\tscrollToElement(targetElement);\n\t});\n\n\tjquery__WEBPACK_IMPORTED_MODULE_0__(targetElement + \" #next-page\").on(\"click\", function () {\n\t\tif (currentPage < totalPages) {\n\t\t\tvar nextPage = currentPage + 1;\n\t\t\tshowPage(nextPage);\n\t\t\tscrollToElement(targetElement);\n\t\t}\n\t});\n\n\tjquery__WEBPACK_IMPORTED_MODULE_0__(targetElement + \" #previous-page\").on(\"click\", function () {\n\t\tif (currentPage > 1) {\n\t\t\tvar prevPage = currentPage - 1;\n\t\t\tshowPage(prevPage);\n\t\t\tscrollToElement(targetElement);\n\t\t}\n\t});\n});\n\n\n//# sourceURL=webpack://ulf/./src/js/modules/pagination.js?");

/***/ }),

/***/ "./src/js/modules/show-menu.js":
/*!*************************************!*\
  !*** ./src/js/modules/show-menu.js ***!
  \*************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
